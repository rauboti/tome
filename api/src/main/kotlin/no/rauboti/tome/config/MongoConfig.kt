 ...
 * auto-configured from `spring.mongodb.uri`; this class only adds the two pieces Boot does not:
 *
 ...
 *  - a [MongoTransactionManager] for `@Transactional` against the single-node replica set;
