 ...
 * <Outlet/>. Campaigns is the landing page (`/`, US2); Characters lives on its own route
 * (`/characters`, US1). Per-campaign, combat, and profile routes arrive with their stories.
 */
