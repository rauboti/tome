 ...
 * `/api/auth/me`). Not a routed page: they are authenticated, so the only action is to sign out
 * (e.g. to switch accounts). A Tome role is granted in Hive, out of band.
 */
