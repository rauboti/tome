...
**Checkpoint**: the 3.5 sheet is as rich as v1 wants — **Phase 3C complete (T105–T114)**: canonical skills, weapons, defense/AC + grapple, feats/gear, full spellcasting (stats + slots + class-filtered SRD spell picker). US1 still green; US2 can begin. Remaining polish: the table-UX layout follow-up (`task_20475fb5`), and school metadata for the spell catalog (deferred in T112) if wanted.
